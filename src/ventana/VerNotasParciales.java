...
public class VerNotasParciales extends JFrame {
    ...
    public VerNotasParciales(Usuario usuario) {
     ...
     // Ocultar la columna "Id" (índice 7) de la vista
        ...
        JButton btnVerAsistencia = new JButton("Ver Notas de Paralelo");
        footer.add(btnVerAsistencia);
        btnVerAsistencia.addActionListener(e -> abrirVentanaNotas());
    ...
    private void abrirVentanaNotas() {
        ...
        try {
            ...
            VerNotas ventana = new VerNotas(idEstudiante, idParalelo);
